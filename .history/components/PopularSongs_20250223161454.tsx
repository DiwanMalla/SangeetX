  ...
  const popularSongs = [
    {
      ...
      cover:
        "https://th.bing.com/th/id/OIP.if5WyQb6gg7PxRLhWMUPdAHaEK?rs=1&pid=ImgDetMain",
      src: "/Suna-Kanchi.mp3",
    },
    {
      id: 2,
    ...
    <section className="py-16 px-4 md:px-8 bg-gray-100 dark:bg-gray-800 bg-opacity-50">
      ...
      <div className="max-w-3xl mx-auto">
        {popularSongs.map((song, index) => (
          <div
            key={song.id}
            className="flex items-center justify-between p-4 mb-4 bg-white dark:bg-gray-700 bg-opacity-50 rounded-lg hover:bg-blue-300 dark:hover:bg-gray-600 transition duration-300"
          >
            ...
            <div className="flex space-x-2">
              <button
                onClick={prevSong}
                className="p-2 rounded-full bg-gray-300 dark:bg-gray-500 hover:bg-gray-400 dark:hover:bg-gray-600 transition duration-300"
              >
                <SkipBack size={20} />
              </button>
              <button
